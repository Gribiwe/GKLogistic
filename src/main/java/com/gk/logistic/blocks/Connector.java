...
public class Connector extends Block implements Registrable {
    ...
    public static final AxisAlignedBB UP_AABB = new AxisAlignedBB(0.0D, 0.0D, 0, 0, 0, 0);
    public static final AxisAlignedBB DOWN_AABB = new AxisAlignedBB(0.0D, 0.0D, 0, 0, 0, 0);
...
//        boolean flag = blockfaceshape == BlockFaceShape.MIDDLE_POLE && (iblockstate.getMaterial() == this.blockMaterial || block instanceof Tube);
        return !isExcepBlockForAttachWithPiston(block) && block instanceof Connector || block instanceof BlockContainer;
    }
